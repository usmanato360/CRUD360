...
<h3 align="center"> <strong>Example 8:</strong> Set up a single table on a single page! with fields displayed (full width) from a records tpl file </h3>
<?php 		
